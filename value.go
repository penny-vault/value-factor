...
type ValueFactor struct {
	IndexName   string `pvbt:"index" desc:"Stock index universe to select from" default:"SP500" suggest:"SP500=SP500|NASDAQ100=NASDAQ100"`
	TopHoldings int    `pvbt:"top-holdings" desc:"Number of cheapest stocks to hold" default:"50" suggest:"SP500=50|NASDAQ100=10"`
}
...
func (s *ValueFactor) Compute(ctx context.Context, eng *engine.Engine, strategyPortfolio portfolio.Portfolio, batch *portfolio.Batch) error {
	...
	valuationDF, err := indexUniverse.At(ctx, eng.CurrentDate(), data.EVtoEBIT)
	if err != nil {
